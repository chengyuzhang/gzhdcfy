...
export default {
	...
	methods: {
		...
		createCalendar(startDateStr, endDateStr){
			...
			// let currentDate = new Date()
			// let setMonth = currentDate.getMonth()+1
			// let setDate = new Date(currentDate.getFullYear(), setMonth, 0)

			// this.year = setDate.getFullYear()
			// this.month = setDate.getMonth() + 1
			// this.daysNum = setDate.getDate()
			// console.log(`${this.year}年`)
			// console.log(`${this.month}月有`,`${this.daysNum}天`)

			// let firstDatOfMonth = new Date(setDate.setDate(1))
			// this.firstDayofWeek = firstDatOfMonth.getDay()
			// console.log(`${this.month}月1号是周`,this.firstDayofWeek)
		},
		toPage(){
			this.$router.push({
				path: '/ksjs'
